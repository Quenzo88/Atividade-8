...
COM_PORT = 'COM6'  # Já ajustado para a sua porta
BAUD_RATE = 115200
...
try:
    ...
    print(f"Conectado na porta {COM_PORT}! Lendo o Acelerômetro...")
...
def update(frame):
    while ser.in_waiting > 0:
        try:
            ...
            # Identifica o padrão ACEL enviado pela placa
            if "ACEL," in line:
    ...
    # Ajusta os limites da tela dinamicamente
